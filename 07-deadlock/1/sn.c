...
int main(void)
{
    ...
    sleep(3);
    printf("2:Now try to acquire s1\n");

    sem_wait(mut1);
    printf("2:Phew... Acquired s1...finally\n");
    printf("2:Thank you puny human for saving me\n");
    
    printf("2:Deadlocks suckk...\n");
